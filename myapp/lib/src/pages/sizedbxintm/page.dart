...
class PageSizedbxintm extends StatefulWidget {
  const PageSizedbxintm({
    Key? key,
  }) : super(key: key);

  @override
  _StateSizedbxintm createState() => _StateSizedbxintm();
}

class _StateSizedbxintm extends State<PageSizedbxintm> {
                  ...
                  return Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(r'''What is Sized Box Widget''',
                      ...
                      Padding(
                        ...
                        child: Text(
                            r'''SizedBox is a built-in widget in flutter SDK.  It is a simple box with a specified size. It can be used to set size constraints to the child widget, put an empty SizedBox between the two widgets to get some space in between, or something else. It is somewhat similar to a Container widget with fewer properties.
...
Widget child}
                      ...
                      Padding(
                        ...
                        child: Text(r'''Properties of SizedBox Widget:
