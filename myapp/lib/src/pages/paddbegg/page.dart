...
class PagePaddbegg extends StatefulWidget {
  const PagePaddbegg({
    Key? key,
  }) : super(key: key);

  @override
  _StatePaddbegg createState() => _StatePaddbegg();
}

class _StatePaddbegg extends State<PagePaddbegg> {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                            r''' You can provide padding to some of the widgets in Flutter. In this tutorial, we will focus on giving padding to a Container widget. But the syntax should be same for any widget that supports padding property.''',
