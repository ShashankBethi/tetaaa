...
class PageSpacerintm extends StatefulWidget {
  const PageSpacerintm({
    Key? key,
  }) : super(key: key);

  @override
  _StateSpacerintm createState() => _StateSpacerintm();
}

class _StateSpacerintm extends State<PageSpacerintm> {
                  ...
                  return Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(r'''What is Spacer Widget''',
                      ...
                      Padding(
                        ...
                        child: Text(
                            r'''Spacer creates an adjustable, empty spacer that can be used to tune the spacing between widgets in a Flex container, like Row or Column.
        ...
        Container(
          ...
          color: Colors.yellow,
                      ...
                      Padding(
                        ...
                        child: Image.network(
                          r'''https://www.woolha.com/media/2020/06/flutter-spacer-flex.jpg''',
                          width: double.maxFinite,
                          height: 150,
                          fit: BoxFit.fill,
                        ),
