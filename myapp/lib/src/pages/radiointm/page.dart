...
class PageRadiointm extends StatefulWidget {
  const PageRadiointm({
    Key? key,
  }) : super(key: key);

  @override
  _StateRadiointm createState() => _StateRadiointm();
}

class _StateRadiointm extends State<PageRadiointm> {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(r'''Radio Button Widget''',
