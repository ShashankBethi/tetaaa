...
class PageLimtbegg extends StatefulWidget {
  const PageLimtbegg({
    Key? key,
  }) : super(key: key);

  @override
  _StateLimtbegg createState() => _StateLimtbegg();
}

class _StateLimtbegg extends State<PageLimtbegg> {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(r'''Limited Box Widget''',
                  ...
                  return Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(r'''What is Limited widget''',
                      ...
                      Padding(
                        ...
                        child: Text(
                            r'''A box that limits its size only when its unconstrained.

If this widgets maximum width is unconstrained then its childs width is limited to maxWidth. Similarly, if this widgets maximum height is unconstrained then its childs height is limited to maxHeight.
