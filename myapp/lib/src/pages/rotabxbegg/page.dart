...
class PageRotabxbegg extends StatefulWidget {
  const PageRotabxbegg({
    Key? key,
  }) : super(key: key);

  @override
  _StateRotabxbegg createState() => _StateRotabxbegg();
}

class _StateRotabxbegg extends State<PageRotabxbegg> {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(r'''Rotated Box Widget''',
                  ...
                  return Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(r'''What is Rotated Box Widget''',
                      ...
                      Padding(
                        ...
                        child: Text(
                            r'''A widget that rotates its child by a integral number of quarter turns.
