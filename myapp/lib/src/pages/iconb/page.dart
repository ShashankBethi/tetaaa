...
class PageIconb extends StatefulWidget {
  const PageIconb({
    Key? key,
  }) : super(key: key);

  @override
  _StateIconb createState() => _StateIconb();
}

class _StateIconb extends State<PageIconb> {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                            r'''A graphical icon widget drawn with a glyph from a font described in an IconData such as materials predefined IconDatas in Icons.

Icons are not interactive. For an interactive icon, consider materials IconButton.
